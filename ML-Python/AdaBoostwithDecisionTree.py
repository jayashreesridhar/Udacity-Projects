...
abc = AdaBoostClassifier(base_estimator=DecisionTreeClassifier(max_features='sqrt',min_samples_split=7,min_samples_leaf=3,max_leaf_nodes=10,max_depth=5),algorithm='SAMME')
