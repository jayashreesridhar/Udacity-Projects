# -*- coding: utf-8 -*-
"""
Created on Mon Jun 12 08:06:56 2017
...
param_grid = {
        ...
        'abc__n_estimators':[10,30,50,70,100],
         'abc__learning_rate':[0.1,0.25,0.5,0.75],
         
          }
scaler = MinMaxScaler()

abc = AdaBoostClassifier(base_estimator=RandomForestClassifier(n_estimators=70,max_features='sqrt',min_samples_split=7,min_samples_leaf=3,max_leaf_nodes=10,max_depth=5,criterion='entropy'),algorithm='SAMME')
